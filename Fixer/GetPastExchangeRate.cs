...
{
    public class GetPastExchangeRate : CodeActivity
    {
        [Category("Input")]
        [RequiredArgument]
        ...
        [Category("Input")]
        [RequiredArgument]
        [Description("The date you wish to get the exchange rate from.")]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var rate = Fixer.Rate(inputCurrency, outputCurrency, pastDate);
